...
[![GoDoc](https://pkg.go.dev/badge/github.com/ElmTheDev/solana-go?status.svg)](https://pkg.go.dev/github.com/ElmTheDev/solana-go@v1.11.0?tab=doc)
[![GitHub tag (latest SemVer pre-release)](https://img.shields.io/github/v/tag/gagliardetto/solana-go?include_prereleases&label=release-tag)](https://github.com/ElmTheDev/solana-go/releases)
[![Build Status](https://github.com/ElmTheDev/solana-go/workflows/tests/badge.svg?branch=main)](https://github.com/ElmTheDev/solana-go/actions?query=branch%3Amain)
[![TODOs](https://badgen.net/https/api.tickgit.com/badgen/github.com/ElmTheDev/solana-go/main)](https://www.tickgit.com/browse?repo=github.com/ElmTheDev/solana-go&branch=main)
[![Go Report Card](https://goreportcard.com/badge/github.com/ElmTheDev/solana-go)](https://goreportcard.com/report/github.com/ElmTheDev/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/ElmTheDev/solana-go/tree/main/programs/serum) is deprecated.**)
...
```bash
$ cd my-project
$ go get github.com/ElmTheDev/solana-go@v1.11.0
```
...
You can wait for a transaction confirmation using the `github.com/ElmTheDev/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	"github.com/ElmTheDev/solana-go"
	lookup "github.com/ElmTheDev/solana-go/programs/address-lookup-table"
	"github.com/ElmTheDev/solana-go/rpc"
...
import (
  ...
  "github.com/ElmTheDev/solana-go"
  "github.com/ElmTheDev/solana-go/programs/system"
  "github.com/ElmTheDev/solana-go/rpc"
  "github.com/ElmTheDev/solana-go/text"
)
...
import (
  ...
  "github.com/ElmTheDev/solana-go/rpc"
  "github.com/ElmTheDev/solana-go/rpc/jsonrpc"
)
...
import (
  ...
  "github.com/ElmTheDev/solana-go/programs/system"
  "github.com/ElmTheDev/solana-go/rpc"
  confirm "github.com/ElmTheDev/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/ElmTheDev/solana-go/rpc/jsonrpc"
  "github.com/ElmTheDev/solana-go/rpc/ws"
  "github.com/ElmTheDev/solana-go/text"
)
...
import (
  ...
  "github.com/davecgh/go-spew/spew"
  bin "github.com/gagliardetto/binary"
  solana "github.com/ElmTheDev/solana-go"
  "github.com/ElmTheDev/solana-go/programs/token"
  "github.com/ElmTheDev/solana-go/rpc"
)
